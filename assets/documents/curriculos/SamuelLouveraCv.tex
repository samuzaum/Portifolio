...
{\large Estagiário de T.I \textbar{} Suporte Técnico e Infraestrutura}\\[5pt]
...
infraestrutura, suporte e automação. Experiência com administração de identidades e acessos (IAM),
migração de dados para nuvem, suporte N1/N2 via GLPI/ITIL, manutenção de hardware e desenvolvimento
de soluções em Python. Perfil proativo, organizado e autônomo, com experiência em trabalho remoto e
foco em resolução de problemas de forma independente.
...
\begin{itemize}
  \item Suporte técnico a usuários em ambiente LMS.
...
\begin{itemize}
  ...
  \item Criação de manuais e procedimentos para colaboradores.
  \item Organização de informações e resolução de problemas em plataformas digitais.
\end{itemize}
